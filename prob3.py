...
def sortCountries (countries,sentimentList,totaloptimaldistance):
...
def Ranking (countries,sentimentList,totaloptimaldistance): # ranking the countries
    rankedCountries = sortCountries(countries, sentimentList, totaloptimaldistance) # sort countries
